...
function draw() {
    ...
    if (gameState === 2) {
        ...
        textSize(30)
        fill("black")
        text("player1score : "+player1score, displayWidth - 250, 550);
        text("player2score : "+player2score, displayWidth - 250, 500)
        }
        if ( timer <= 0) {
            textSize(30)
            fill("black")
            ...
            text("time over");
            gameState = 3;
            text("Is the painting matching the picture?", displayWidth/2 - 650, 500)
            var matching = createSprite (displayWidth/2 - 550, 575, 198, 50);
            matching.scale = 0.3
            matching.addImage (image9)
            var notmatching = createSprite (displayWidth/2 - 290, 575, 198, 50);
